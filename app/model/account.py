...
class ts_account(db.Model):
    ...
    privilege_code = db.Column(db.String(10), nullable=True)
    company_code = db.Column(db.String(10), nullable=True)
    client_code = db.Column(db.String(10), nullable=True)
    departement_code = db.Column(db.String(10), nullable=True)
    team_code = db.Column(db.String(10), nullable=True)
